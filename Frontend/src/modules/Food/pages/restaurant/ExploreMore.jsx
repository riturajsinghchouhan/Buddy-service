        ...
        >
          ...
          <div className="border-t border-gray-200 px-4 py-4 flex justify-center">
            <button
              ...
              className="text-[#23361A] hover:text-[#1a2614] font-bold text-base transition-colors"
            >
              Okay
            </button>
          </div>
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 transition-all duration-200 rounded-full ${profileOpen ? "bg-[#23361A] text-white shadow-lg" : "bg-gray-100 hover:bg-gray-200 text-gray-900"}`}
              aria-label="Profile"
            >
      ...
      <div className="px-4 py-6">
        ...
        >
          <Card 
            className="bg-white border-gray-200 py-3 mb-6 rounded-lg shadow-0 hover:border-[#23361A]/30 hover:bg-[#23361A]/5 transition-all active:scale-[0.99] cursor-pointer"
            onClick={() => navigate("/food/restaurant/outlet-info")}
          >
            <CardContent className="px-4">
              <div className="w-full flex items-center justify-between">
                <div className="flex items-center gap-3 flex-1">
                  <div className="p-2 bg-gray-100 rounded-lg group-hover:bg-[#23361A]/10 transition-colors">
                    <Store className="w-5 h-5 text-gray-900 group-hover:text-[#23361A]" />
                  </div>
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-between gap-3 rounded-2xl border border-[#23361A]/20 bg-[#23361A]/5 px-4 py-4 text-left hover:bg-[#23361A]/10 transition-all active:scale-[0.99]"
        >
          <div className="flex items-center gap-3 min-w-0">
            <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#23361A]/10">
              <LogOut className="w-5 h-5 text-[#23361A]" />
            </div>
            <div className="min-w-0">
              <p className="text-base font-semibold text-[#23361A]">Logout</p>
              <p className="text-sm text-[#23361A]/60 font-medium">Tap to sign out from this device</p>
            </div>
          </div>
          <ChevronRight className="w-5 h-5 text-[#23361A]/40 shrink-0" />
        </motion.button>
      </div>
          ...
          <>
            ...
            >
              <div className="text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-[#23361A]/10">
                  <LogOut className="w-5 h-5 text-[#23361A]" />
                </div>
              ...
              <div className="mt-5 grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  disabled={isLoggingOut}
                  className="rounded-2xl bg-[#23361A] px-4 py-3 text-sm font-bold text-white transition-all hover:bg-[#1a2614] active:scale-95 disabled:opacity-50"
                >
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    autoFocus
                    className="w-full px-4 py-2 pr-10 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#23361A] text-gray-900 placeholder-gray-500"
                  />
                  {searchQuery && (
                    <button
          ...
          <>
            ...
            >
              ...
              <div className="px-6 py-6">
                ...
                >
                  {/* Avatar */}
                  <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center shrink-0 overflow-hidden ring-4 ring-[#23361A]/10 group-hover:ring-[#23361A]/20 transition-all">
                    {userData.profileImage?.url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#23361A]/5 to-[#23361A]/20">
                        <User className="w-8 h-8 text-[#23361A]" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] font-bold text-[#23361A] uppercase tracking-widest mt-2 bg-[#23361A]/5 w-fit px-2.5 py-1 rounded-full border border-[#23361A]/10">
                      {userData.role}
                    </p>
                  </div>
                </button>
              ...
              <div className="px-6 pb-6 space-y-3">
                ...
                <button
                  ...
                  disabled={isLoggingOut}
                  className="w-full bg-[#23361A]/10 text-[#23361A] border border-[#23361A]/20 hover:bg-[#23361A]/20 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed font-bold py-4 px-4 rounded-2xl transition-all flex items-center justify-center gap-2"
                >
                  <LogOut className="w-5 h-5 text-[#23361A]" />
                ...
                <button
                  ...
                  disabled={isLoggingOut}
                  className="w-full bg-[#23361A]/10 text-[#23361A] border border-[#23361A]/20 hover:bg-[#23361A]/20 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed font-bold py-4 px-4 rounded-2xl transition-all"
                >
            ...
            >
              ...
              <div className="px-6 py-6 space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-[#23361A] hover:bg-[#1a2614] text-white font-bold py-3.5 px-4 rounded-xl transition-all shadow-md active:scale-[0.98] mt-4"
                >
                  Submit
                </button>
              </div>
            ...
            >
              <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center">
                ...
                <button
                  ...
                  className="w-full bg-[#23361A] text-white py-3.5 rounded-xl font-bold text-sm hover:bg-[#1a2614] transition-all shadow-md active:scale-[0.98]"
                >
                  Done 
                </button>
              </div>
