                  ...
                  <button
                    ...
                    className={`h-10 text-sm rounded transition-colors ${!isCurrent
                        ...
                        : isSelectedDate
                          ...
                          : isTodayDate
                            ? 'bg-[#f9f0f7] text-[#23361A] font-semibold'
        ...
        <div ref={tabBarRef} className="grid grid-cols-2 gap-3">
          <motion.button
            ...
            className={`relative overflow-hidden rounded-[24px] border px-4 py-3 text-sm font-semibold ${
              activeTab === "all-items"
                ? "border-[#23361A] text-white shadow-[0_18px_32px_-24px_rgba(126,56,102,0.6)]"
          ...
          >
            {activeTab === "all-items" && (
              <motion.div
                ...
                className="absolute inset-0 rounded-[24px] bg-[#23361A] -z-10"
                initial={false}
                transition={{
                  type: "spring",
                  stiffness: 500,
            ...
            <span className="relative z-10 flex min-h-7 items-center justify-center gap-2 leading-none">
              ...
              <span className={`inline-flex min-h-5 min-w-[24px] items-center justify-center rounded-full px-2 py-0.5 text-xs font-semibold ${
                activeTab === "all-items" ? "bg-white text-[#23361A]" : "bg-[#f6ecf3] text-[#6d6470]"
              }`}>
                {totalItems}
              </span>
            </span>
          ...
          >
            ...
            <span className="relative z-10 flex min-h-7 items-center justify-center gap-2 leading-none">
              ...
              <span className={`inline-flex min-h-5 min-w-[24px] items-center justify-center rounded-full px-2 py-0.5 text-xs font-semibold ${
                activeTab === "add-ons" ? "bg-white text-[#23361A]" : "bg-[#f6ecf3] text-[#6d6470]"
              }`}>
                {addons.length}
              </span>
            </span>
          ...
          <div className="overflow-hidden rounded-[28px] border border-white/80 bg-white/90 p-4 shadow-[0_20px_48px_-34px_rgba(15,23,42,0.45)] backdrop-blur">
            ...
            <div className="mt-4 flex gap-2 flex-wrap">
              ...
              <button
                ...
                className="relative flex h-12 items-center justify-center gap-2 rounded-[20px] border border-[#e7d5e0] bg-white px-4 text-sm font-semibold text-[#A2B447] transition-colors hover:border-[#d5bdd0] hover:bg-[#f9f0f7]"
              >
                <SlidersHorizontal className="w-4 h-4 text-[#23361A]" />
                <span>Filters</span>
                {selectedFilter !== "all" && (
                  <span className="absolute right-1.5 top-1.5 h-2.5 w-2.5 rounded-full bg-[#23361A] ring-2 ring-white" />
                )}
              </button>
              ...
              {activeTab === "add-ons" && (
                <button
                  ...
                  className="h-12 rounded-[20px] bg-[#23361A] px-4 text-sm font-semibold text-white shadow-[0_18px_32px_-24px_rgba(126,56,102,0.7)] transition-colors hover:bg-[#A2B447]"
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 rounded-full border px-3.5 py-2 text-xs font-semibold transition-colors ${
                      isActive
                        ? "border-[#23361A] bg-[#23361A] text-white shadow-[0_14px_28px_-24px_rgba(126,56,102,0.8)]"
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#23361A] focus:outline-none"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#23361A] focus:outline-none resize-none"
                        rows={3}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#23361A] text-white rounded-md text-sm font-medium hover:bg-[#A2B447] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                      >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className={`${selectedFilter !== "all" ? 'flex-1' : 'w-full'} bg-[#23361A] text-white py-3 rounded-lg font-medium hover:bg-[#A2B447] transition-colors`}
                  >
                    Apply
                  </button>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button
                    ...
                    className="flex-1 bg-[#23361A] text-white py-3 rounded-lg font-medium hover:bg-[#A2B447] transition-colors"
                  >
                    Confirm
                  </button>
                </div>
      ...
      {activeTab !== "add-ons" && (
        <div className="fixed right-4 bottom-24 z-30 flex flex-col items-end gap-2">
          <motion.button
            ...
            className="rounded-full bg-[#23361A] px-5 py-3 text-sm font-semibold text-white shadow-[0_22px_40px_-24px_rgba(126,56,102,0.72)]"
          >
            + Add item
          </motion.button>
          <motion.button
            ...
            className="flex items-center gap-2 rounded-full border border-[#ead6e3] bg-white/95 px-4 py-3 text-sm font-semibold text-[#A2B447] shadow-[0_18px_36px_-28px_rgba(126,56,102,0.45)]"
          >
            <span className="w-5 h-5 flex items-center justify-center">
              {isMenuOpen ? (
                <X className="w-4 h-4 text-[#A2B447]" />
              ) : (
                <Utensils className="w-4 h-4 text-[#23361A]" />
              )}
            </span>
                ...
                >
                  <div className="h-full flex flex-col">
                    <div className="bg-[linear-gradient(135deg,#fcf4f9_0%,#f6e8f1_100%)] px-4 pt-4 pb-3">
                      <p className="text-sm font-semibold text-[#A2B447]">Jump to category</p>
                    </div>
