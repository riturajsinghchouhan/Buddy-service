        ...
        >
          ...
          >
            <div className="absolute top-4 left-4 right-4 z-20">
              <div className="relative group shadow-2xl">
                ...
                <Input
                  ...
                  className="pl-10 h-12 bg-white/95 dark:bg-[#1a1a1a]/95 backdrop-blur-md border-none rounded-xl shadow-lg focus:ring-2 focus:ring-[#16A34A] transition-all"
                />
                {isKeywordSearching && (
                  <div className="absolute right-3 top-1/2 -translate-y-1/2">
                     <div className="animate-spin rounded-full h-4 w-4 border-2 border-[#16A34A] border-t-transparent" />
                  </div>
                )}
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-[#1a1a1a] rounded-xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden z-30 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    {keywordAddressSuggestions.map((s) => (
                      <button
                        ...
                        className="w-full px-4 py-3 flex items-start gap-3 hover:bg-[#16A34A]/5 dark:hover:bg-[#16A34A]/10 transition-colors text-left border-b border-gray-50 dark:border-gray-800 last:border-none"
                      >
            ...
            <div className="absolute bottom-10 right-4 z-10">
              ...
              >
                <Navigation className="h-4 w-4 mr-2 text-[#16A34A]" /> Use My Location
              </Button>
            </div>
          </div>
          ...
          <div className="relative bg-white dark:bg-[#0a0a0a] rounded-t-[32px] -mt-8 z-10 p-4 space-y-6 shadow-[0_-12px_24px_-10px_rgba(0,0,0,0.1)]">
            <div className="bg-[#16A34A]/5 dark:bg-[#16A34A]/10 border border-[#16A34A]/10 dark:border-[#16A34A]/20 rounded-xl p-4 flex gap-3">
               <MapPin className="h-5 w-5 text-[#16A34A] mt-0.5" />
               <div className="min-w-0">
                  <p className="text-xs font-bold text-[#16A34A] dark:text-[#16A34A]/80 uppercase mb-1">Pinnned Location</p>
            ...
            <div>
              ...
              <Input 
                ...
                className="h-12 rounded-xl border-gray-200 dark:border-gray-800 focus:ring-[#16A34A]"
              />
            </div>
               ...
               <div className="flex gap-2">
                 {["Home", "Work", "Other"].map(l => (
                   <Button 
                     ...
                     className="flex-1"
                     style={addressFormData.label === l ? {backgroundColor: '#16A34A', color: 'white'} : {}}
                   >
                     {l}
                   </Button>
                 ))}
    ...
    <AnimatedPage className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto pb-10">
        <div className="p-4 bg-gray-50 dark:bg-gray-900 border-b dark:border-gray-800">
          ...
          >
            <div className="h-10 w-10 rounded-full bg-[#16A34A10] dark:bg-[#16A34A20] flex items-center justify-center">
              <Navigation className="h-5 w-5 text-[#16A34A]" />
            </div>
            <div className="text-left flex-1">
              <p className="font-bold text-[#16A34A]">Use Current Location</p>
        ...
        <div className="p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="ghost" className="text-[#16A34A] p-0 h-auto font-bold" onClick={handleAddAddressClick}>
              ...
              addresses.map((addr, idx) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-start gap-4 p-4 bg-slate-50 dark:bg-[#1a1a1a] rounded-xl hover:bg-[#16A34A10] dark:hover:bg-[#16A34A20] transition-colors text-left group"
                  >
                    ...
                    <div className="h-6 w-6 rounded-full border border-gray-200 dark:border-gray-700 mt-2 flex items-center justify-center group-hover:border-[#16A34A]">
                       <ChevronRight className="h-3 w-3 text-gray-400 group-hover:text-[#16A34A]" />
                    </div>
                  </button>
                )
              })
