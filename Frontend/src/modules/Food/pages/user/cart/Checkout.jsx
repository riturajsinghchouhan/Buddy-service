                          ...
                          >
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                {address.isDefault && (
                                  <Badge className="mb-2 bg-[#23361A] text-white">Default</Badge>
                                )}
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                  {payment.isDefault && (
                                    <Badge className="bg-[#23361A] text-white">Default</Badge>
                                  )}
                ...
                <CardContent className="space-y-4 md:space-y-6">
                  ...
                  <div className="space-y-2 md:space-y-3 pt-4 md:pt-6 border-t dark:border-gray-700">
                    ...
                    <div className="flex justify-between font-bold text-lg md:text-xl lg:text-2xl pt-2 md:pt-3 border-t dark:border-gray-700">
                      ...
                      <span className="text-[#23361A] dark:text-orange-400">₹{total.toFixed(0)}</span>
                    </div>
                  </div>
