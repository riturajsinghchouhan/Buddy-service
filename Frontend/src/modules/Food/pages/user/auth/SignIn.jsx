        ...
        <div className="p-6 sm:p-8 md:p-10 space-y-6 md:space-y-8">
          ...
          <form id="user-signin-form" onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              ...
              className="w-full h-12 md:h-14 bg-primary hover:bg-[#15803D] text-white font-bold text-base md:text-lg rounded-lg transition-all hover:shadow-lg active:scale-[0.98]"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
