                ...
                gourmetRestaurants.map((item) => {
                  ...
                  return (
                    <Link key={restaurantId} to={`/user/restaurants/${restaurantSlug}`}>
                      <Card className="overflow-hidden cursor-pointer border-0 group bg-white dark:bg-[#1a1a1a] shadow-xl shadow-gray-200/20 dark:shadow-none hover:shadow-2xl hover:shadow-[#16A34A]/5 transition-all duration-500 py-0 rounded-[32px] mb-4 group active:scale-[0.98]">
                        {/* Image Section */}
                        <div className="relative h-48 sm:h-56 md:h-60 w-full overflow-hidden rounded-t-[32px]">
                          ...
                          <div className="absolute bottom-4 right-4 flex items-center gap-1.5 bg-white px-3 py-1.5 rounded-2xl shadow-2xl">
                             ...
                             <Star className="h-3.5 w-3.5 fill-[#16A34A] text-[#16A34A]" />
                          </div>
                        </div>
                        ...
                        <CardContent className="p-5">
                          ...
                          <div className="flex items-center justify-between gap-2 mb-3">
                            <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 truncate group-hover:text-[#16A34A] transition-colors">
                          ...
                          <div className="flex items-center gap-4 text-[12px] text-gray-500 dark:text-gray-400 mb-4 font-bold uppercase tracking-tight">
                            <div className="flex items-center gap-1.5">
                              <Clock className="h-4 w-4 text-[#16A34A]" strokeWidth={2.5} />
                          ...
                          {/* Offer Badge */}
                          {restaurant.offer ? (
                            <div className="flex items-center gap-2.5 px-3 py-2 bg-[#16A34A]/5 dark:bg-[#16A34A]/10 rounded-2xl w-fit">
                              <BadgePercent className="h-4 w-4 text-[#16A34A]" strokeWidth={3} />
                              <span className="text-[10px] font-black text-[#16A34A] uppercase tracking-wider">{restaurant.offer}</span>
                            </div>
                          ) : (
