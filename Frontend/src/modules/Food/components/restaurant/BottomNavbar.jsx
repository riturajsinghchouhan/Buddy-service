      ...
      <div className="flex items-center justify-around py-2 px-4">
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant") ? "text-[#16A34A]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/orders") ? "text-[#16A34A]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 -mt-8 transition-colors ${
            isActive("/food/restaurant/explore") ? "text-[#16A34A]" : "text-gray-600"
          }`}
        >
          <div
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/wallet") ? "text-[#16A34A]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/food/all") ? "text-[#16A34A]" : "text-gray-600"
          }`}
        >
