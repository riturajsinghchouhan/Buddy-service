...
const ROUTE_THEMES = {
  ...
  dining: {
    shell: "border-0 bg-transparent text-white",
    card: "flex-1 rounded-xl sm:rounded-2xl border border-white/20 bg-white/12 px-2 py-1.5 sm:px-3 sm:py-2 shadow-sm text-white backdrop-blur-md",
    iconBtn: "h-9 w-9 sm:h-10 sm:w-10 rounded-xl border border-white/15 bg-white/10 text-white backdrop-blur-sm hover:bg-white/20",
    label: "text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.18em] text-green-300/90",
    title: "text-xs sm:text-sm font-extrabold text-white",
    sub: "hidden sm:block text-[11px] font-semibold text-white/70",
    chevron: "text-white/70",
    cartBadge: "ring-white/30",
    showBack: true,
    titleText: "Dining",
