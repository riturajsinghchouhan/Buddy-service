...
const ROUTE_THEMES = {
  ...
  dining: {
    shell: "border-b border-amber-100/80 bg-[#faf7f4]/95 backdrop-blur-xl dark:border-amber-900/30 dark:bg-[#1a1410]/95",
    card: "flex-1 rounded-2xl border border-amber-200/70 bg-white px-3 py-2 shadow-sm dark:border-amber-900/40 dark:bg-[#241a14]",
    iconBtn: "h-10 w-10 rounded-xl border border-amber-200/80 bg-white text-amber-900 shadow-sm dark:border-amber-900/40 dark:bg-[#2c1810] dark:text-amber-100",
    label: "text-[10px] font-bold uppercase tracking-[0.18em] text-amber-700 dark:text-amber-400",
    title: "text-sm font-extrabold text-gray-900 dark:text-white",
    sub: "text-[11px] font-semibold text-amber-700/70 dark:text-amber-300/70",
    chevron: "text-amber-600 dark:text-amber-400",
    cartBadge: "ring-white dark:ring-[#1a1410]",
    showBack: true,
    titleText: "Dining",
  },
  under250: {
